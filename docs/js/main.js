...
var _code_star$elm_codestar_website$Msg$Name = function (a) {
...
var _code_star$elm_codestar_website$Main$viewLandingPage = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('landing-page'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Coming up...'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
...
var _code_star$elm_codestar_website$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A2(_code_star$elm_codestar_website$Main$viewDummyPage, model, 'green'),
					_1: {
						ctor: '::',
						_0: A2(_code_star$elm_codestar_website$Main$viewDummyPage, model, 'papayawhip'),
						_1: {
							ctor: '::',
